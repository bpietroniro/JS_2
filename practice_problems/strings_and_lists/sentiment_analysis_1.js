...
function sentiment(text) {
  let words = text.toLowerCase().split(/[\s\W]+/);
  ...
  let textSentiment;
  const positiveScore = positiveWordsFound.length;
  const negativeScore = negativeWordsFound.length;
  ...
  console.log(`There are ${positiveScore} positive words in the text.`);
  console.log(`Positive sentiments: ${positiveWordsFound.join(', ')}`);
  console.log('\n');
  console.log(`There are ${negativeScore} negative words in the text.`);
